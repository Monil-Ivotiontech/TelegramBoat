...
import { UtilVariable } from '../const';
...
export class UtilService {
  ...
  getGEOLocation(ip: string) {
    ...
    let url = `https://api.ipgeolocation.io/ipgeo?apiKey=${UtilVariable.GEOAPI_KEY}&ip=${ip}`
    return this.http.get(url).pipe(take(1))

  }

  // geoCookiesRequestCall() {
  //   return this.http.get('https://geolocation-db.com/json').pipe(take(1))
  // }
